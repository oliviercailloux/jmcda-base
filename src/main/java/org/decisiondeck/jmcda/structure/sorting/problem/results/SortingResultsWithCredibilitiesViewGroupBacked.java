...
/**
 * A writeable view that reads and writes through an {@link IGroupSortingResultsWithCredibilities} object. This object
 * reads the information from a given decision maker: reading the shared information is not supported as the assignments
 * can't be shared.
 * 
 * @author Olivier Cailloux
 * 
 */
public class SortingResultsWithCredibilitiesViewGroupBacked extends SortingPreferencesViewGroupBacked implements
     ...
     *            not <code>null</code>.
     */
    public SortingResultsWithCredibilitiesViewGroupBacked(IGroupSortingResultsWithCredibilities delegate,
	    DecisionMaker dm) {
	super(delegate, dm);
	m_delegate = delegate;
    }
	...
	final IOrderedAssignmentsWithCredibilities assignments = m_delegate.getAssignments(getViewedDm());
