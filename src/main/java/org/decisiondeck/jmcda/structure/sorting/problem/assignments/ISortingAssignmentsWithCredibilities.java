 ...
 * alternative is assigned to a set of categories, each being associated with a positive degree of credibility.
 * </p>
 * <p>
 ...
 * 
 */
public interface ISortingAssignmentsWithCredibilities extends ISortingData {
    /**
     * <p>
     ...
     * {@link #getAssignments()} and {@link IOrderedAssignmentsWithCredibilities#getCategories()}). Similarily, renaming
     * a category through the returned object renames the category for the assignments if they use that category. Adding
     * a category through the returned object does <em>not</em> add the category to the assignments, as these may use a
