 ...
 * alternative is assigned to at most one category.
 * </p>
 * <p>
 ...
 * 
 */
public interface ISortingAssignments extends ISortingAssignmentsToMultipleRead {
    /**
     * <p>
     ...
     * {@link #getAssignments()} and {@link IOrderedAssignments#getCategories()}). Similarily, renaming a category
     * through the returned object renames the category for the assignments if they use that category. Adding a category
     * through the returned object does <em>not</em> add the category to the assignments, as these may use a subset of
     * the categories defined in this object.
     * </p>
     * 
     * @return not {@code null}.
     */
