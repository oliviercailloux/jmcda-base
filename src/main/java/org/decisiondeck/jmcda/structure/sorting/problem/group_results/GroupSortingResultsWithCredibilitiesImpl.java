...
public class GroupSortingResultsWithCredibilitiesImpl extends GroupSortingPreferencesForwarder implements
     ...
     * 
     */
    static private class OrderedAssignmentsWithCredibilitiesWriteable extends
	    OrderedAssignmentsWithCredibilitiesForwarder implements IOrderedAssignmentsWithCredibilities {

	private final IGroupSortingAssignmentsWithCredibilities m_sorting;

	public OrderedAssignmentsWithCredibilitiesWriteable(IGroupSortingAssignmentsWithCredibilities assignments,
		IOrderedAssignmentsWithCredibilities delegate) {
	    super(delegate);
	...
	public boolean setCredibilities(Alternative alternative, Map<Category, Double> credibilities) {
	    ...
	    Preconditions.checkArgument(getCategories().containsAll(credibilities.keySet()), "Unknown category.");
	    Preconditions
		    .checkArgument(m_sorting.getCatsAndProfs().getCategories().containsAll(credibilities.keySet()));
     ...
     * </p>
     */
    private final Map<DecisionMaker, IOrderedAssignmentsWithCredibilities> m_allAssignments = Maps.newLinkedHashMap();
	...
	final Map<DecisionMaker, IOrderedAssignmentsWithCredibilities> transformed = Maps
		.transformEntries(
			m_allAssignments,
			new EntryTransformer<DecisionMaker, IOrderedAssignmentsWithCredibilities, IOrderedAssignmentsWithCredibilities>() {
			    @Override
			    public IOrderedAssignmentsWithCredibilities transformEntry(DecisionMaker key,
				    IOrderedAssignmentsWithCredibilities value) {
	...
	final IOrderedAssignmentsWithCredibilities created = AssignmentsFactory
