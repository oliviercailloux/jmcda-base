...
public interface IAssignmentsWithCredibilitiesRead extends IAssignmentsToMultipleRead {
     ...
     * later change, this change is not reflected to the object this method returns) and contain no <code>null</code>
     ...
     * <ul>
     * <li>Supposing this object does not implement {@link IOrderedAssignmentsToMultipleRead}, this is <code>true</code>
